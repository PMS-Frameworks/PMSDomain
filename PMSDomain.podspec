...
Pod::Spec.new do |s|
  s.name             = 'PMSDomain'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PMSDomain.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/goeun1001/PMSDomain'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'goeun1001' => 'gogo8272@gmail.com' }
  s.source           = { :git => 'https://github.com/goeun1001/PMSDomain.git', :tag => s.version.to_s }
